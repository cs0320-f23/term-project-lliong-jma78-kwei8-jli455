...
export default function Home() {
  ...
  return(
    <div className="home-page" style={{background:"#FCADAD"}}>
      <img src={logo} style={{display:"flex", width:"10vw", height:"20vh", paddingLeft:"45vw", paddingTop:"20vh"}}></img>
      <h1 style={{fontSize:"100px"}}>Ablaze</h1>
      <h2 style={{textAlign:"center"}}>Discover and Support Asian-Owned Businesses and Artists</h2>
