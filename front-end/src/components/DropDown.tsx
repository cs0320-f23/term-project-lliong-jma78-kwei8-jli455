  ...
  return (
    <div id="nav-bar">
      <nav className="nav-container">
        <header
          id="header-row"
          aria-label="dropdown navigation bar"
          style={{ float: "right" }}
        >
          <div className="nav-pages" style={{}}>
            <img
              src={logo}
              style={{ width: "90px", height: "80px", paddingInline: "50px" }}
              onClick={() => navigate("/home")}
            ></img>
          </div>
          <div
            className="nav-pages"
            style={{ float: "left", paddingRight: "50vw" }}
          >
            <h1 onClick={() => navigate("/home")} style={{ fontSize: "40px" }}>
              Ablaze
            </h1>
          </div>
              ...
              {showSubmit ? (
                <div>
                  <div className="dropdown-menu">
                    ...
                    >
                      <h3>
                        <Link to="/submit_artists">Submit Artists</Link>
                      </h3>
                      <h3>
                        <Link to="/submit_businesses">Submit Businesses</Link>
                      </h3>
                    </ul>
                  </div>
                </div>
